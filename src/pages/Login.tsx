    ...
    <div className="min-h-screen flex items-center justify-center p-6 bg-slate-50 font-sans">
      ...
      >
        ...
        <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
          ...
          <button 
            type="submit"
            className="w-full bg-indigo-600 text-white py-5 rounded-2xl font-black text-lg shadow-xl shadow-indigo-600/30 flex items-center justify-center gap-3 hover:bg-indigo-700 active:scale-95 transition-all group mt-4"
          >
            Get Started
